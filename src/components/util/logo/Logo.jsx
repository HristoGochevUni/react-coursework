export function Logo() {
    return <svg className="mr-3 h-6 sm:h-9" enableBackground="new 0 0 480 400"
                viewBox="0 0 480 400">
        ...
        <g>
            ...
            <g>
                ...
                <g>
                    ...
                    <path
                        ...
                        fill="#E5E5E5"/>
                    <g>
                        <path d="M301.9,325.3c3-1.7,4.8-5,4.8-9.7c0-0.4,0-0.8,0-1.1l-11-1.7L301.9,325.3z"
                              fill="#2D3134"/>
                        <path d="M293.1,303.6l11.5,2.5c-2.4-5.7-6.7-11.3-11.9-14.9L293.1,303.6z"
                              fill="#2D3134"/>
                        <path d="M284.8,299.5l0.4-12c-5.2-1.5-9.5-0.3-11.9,3L284.8,299.5z"
                              fill="#2D3134"/>
                        <path
            ...
            <g>
                ...
                <g>
                    ...
                    <path
                        ...
                        fill="#E5E5E5"/>
                    <g>
                        <path d="M109.8,228.5c3-1.7,4.8-5,4.8-9.7c0-0.4,0-0.8,0-1.1l-11-1.7L109.8,228.5z"
                              fill="#2D3134"/>
                        <path d="M100.9,206.8l11.5,2.5c-2.4-5.7-6.7-11.3-11.9-14.9L100.9,206.8z"
                              fill="#2D3134"/>
                        <path d="M92.7,202.7l0.4-12c-5.2-1.5-9.5-0.3-11.9,3L92.7,202.7z"
                              fill="#2D3134"/>
                        <path
            ...
            <path d="M102.1,142.6l162.2,94.7c0,0-15.7-69-71.1-96.8S102.1,142.6,102.1,142.6z"
                  fill="#2D3134"/>
            <path
            ...
            <path
                ...
                opacity="0.2"/>
            <path d="M112.4,160.6l-2.3,2.6c0,0,16.7,10.9,18.2,8.7C129.9,169.8,112.4,160.6,112.4,160.6z"
                  fill="#F8EBCB"/>
            <path
                d="M197.4,210.1c0,2.9-2.4,4.1-5.3,2.7c-2.9-1.5-5.3-5-5.3-8c0-2.9,2.4-4.1,5.3-2.7   C195,203.6,197.4,207.1,197.4,210.1z"
                opacity="0.2"/>
            <path d="M183.6,201l-2.3,2.6c0,0,16.7,10.9,18.2,8.7C201.1,210.2,183.6,201,183.6,201z"
                  fill="#F8EBCB"/>
            <path
